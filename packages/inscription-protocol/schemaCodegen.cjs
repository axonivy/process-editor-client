...
var schemaUri =
  'https://jenkins.ivyteam.io/job/core_json-schema/job/release%252F12.0/lastSuccessfulBuild/artifact/workspace/ch.ivyteam.ivy.inscription.lsp.schema/target/schema/process/12.0.5/inscription.json';
